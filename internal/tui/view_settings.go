...
func newSettingsModel(cfg config.Config) *settingsModel {
	...
	s.fields = []setting{
		...
		boolSetting("assets.covers", "Sync covers",
		...
		boolSetting("assets.icons", "Sync disc icons",
			func(c config.Config) bool { return c.Assets.Icons },
			func(c *config.Config, v bool) { c.Assets.Icons = v }),
